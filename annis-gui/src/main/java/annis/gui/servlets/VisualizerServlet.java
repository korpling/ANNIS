...
import annis.gui.resultview.ResultSetPanel;
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
    ...
    if(visualizer != null)
    {
      ...
      else
      {
        ...
        if(session.getAttribute(ResultSetPanel.FILESYSTEM_CACHE_RESULT) != null)
        {
          try
          {
            Cache cacheAnnisResult = (Cache) session.getAttribute(ResultSetPanel.FILESYSTEM_CACHE_RESULT);

...
//    setWidth("99%");
  ...
  public void updateFlatQueryBuilder()
  {
    try{
      SearchUI ui = (SearchUI) UI.getCurrent();
      FlatQueryBuilder fqb = (FlatQueryBuilder) ui.getQueryBuilderChooser().getQueryBuilder();
      fqb.initialize();
    } catch (Exception e){ }
  }

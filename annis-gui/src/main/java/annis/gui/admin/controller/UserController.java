...
public class UserController implements UserListView.Listener, UIView.Listener {
    ...
    private static final long serialVersionUID = 8252752872782937444L;
    ...
    public UserController(UserManagement model, UserListView view, UIView uiView, boolean isLoggedIn) {
        this.model = model;
        this.view = view;
        this.uiView = uiView;
    ...
    public void addNewUser(String userName) {
        if (userName == null || userName.isEmpty()) {
            ...
            // each user should be per default able to see the same corpora as a non-logged
            // in user
    ...
    private void fetchFromService() {
        ...
        uiView.runInBackground(() -> model.fetchFromService(), new FutureCallback<Boolean>() {
            @Override

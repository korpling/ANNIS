...
public class QueryBuilderChooser extends Panel implements Property.ValueChangeListener {
    ...
    public QueryBuilderChooser(QueryController controller, PluginSystem pluginSystem, InstanceConfig instanceConfig) {
    ...
    public void valueChange(ValueChangeEvent event) {
        QueryBuilderPlugin plugin = pluginRegistry.get(event.getProperty().getValue());
        if (plugin == null) {

...
public class ImportDialog extends javax.swing.JDialog {
            ...
            if (corpora == null) {
                try {
                    SwingUtilities.invokeLater(() -> {
                        lblCurrentCorpus
                                .setText("import " + StringUtils.abbreviateMiddle(txtInputDir.getText(), "...", 50));
                        pbCorpus.setMaximum(1);
                        pbCorpus.setMinimum(0);
                        pbCorpus.setValue(0);
                    });

                    corpusAdministration.getAdministrationDao().registerGUICancelThread(statementController);

                    importStatus.add(corpusAdministration.importCorporaSave(jCheckBox1.isSelected(), false, null, null,
                            false, txtInputDir.getText()));
                ...
                for (Map<String, Object> corpus : corpora) {
                    ...
                    if (corpus.containsKey("source_path")) {
                        ...
                        try {
                            ...
                            importStatus.add(corpusAdministration.importCorporaSave(jCheckBox1.isSelected(), false,
                                    null, null, false, path));
                        } catch (Exception ex) {
     ...
     * 
     */
    private static final long serialVersionUID = 8126568258537994835L;
    ...
    public ImportDialog(java.awt.Frame parent, boolean modal, CorpusAdministration corpusAdmin,
        ...
        this.importStatus = this.corpusAdministration.getAdministrationDao().initImportStatus();
    ...
    private void initComponents() {
        ...
        btCancel.addActionListener(evt -> btCancelActionPerformed(evt));

        btOk.setMnemonic('o');
        btOk.setText("Ok");
        btOk.addActionListener(evt -> btOkActionPerformed(evt));

        btSearchInputDir.setText("...");
        btSearchInputDir.addActionListener(evt -> btSearchInputDirActionPerformed(evt));
        ...
        layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
                ...
                .addGap(6, 6, 6)
                .addComponent(pbImport, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
                        javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel2)
                        .addComponent(lblStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 15,
                                javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(btCancel)
                        .addComponent(btOk))
                .addContainerGap()));

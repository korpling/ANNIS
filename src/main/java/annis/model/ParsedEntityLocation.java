...
/**
 * The location of some entity in the query when it was parsed. Can be used to define e.g. error
 * locations.
 * 
...
public class ParsedEntityLocation implements Serializable {
   ...
   * 
   */
  private static final long serialVersionUID = 6909594263739925217L;

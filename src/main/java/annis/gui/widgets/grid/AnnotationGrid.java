...
public class AnnotationGrid extends AbstractComponent implements LegacyComponent {
  ...
  /**
   * when true, all html tags are rendered as text and are shown in grid cells. Does not effect row
   * captions.
   */
  private boolean escapeHTML = true;

  public AnnotationGrid(MediaController mediaController, PDFController pdfController,
      String resultID) {
  ...
  private ArrayList<String> getStyles(GridEvent event, String annoName) {
    ...
    if (event.getMatch() != null) {
      ...
      // prefix
      styles.add("v-table-cell-content-" + MatchedNodeColors.colorClassByMatch(event.getMatch()));
    }

...
/**
 * A class for finding optimal horizontal positions for node labels given all intervening vertical
 * edges.
 */
public class OrderedNodeList {
  ...
  private Collection<Double> findConflicts(NodeStructureData nodeStructureData, double minX,
      double maxX) {

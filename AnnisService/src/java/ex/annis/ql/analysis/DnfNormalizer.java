...
public class DnfNormalizer extends DepthFirstAdapter {
	...
	public PExpr normalize(PExpr expr) {
		if (expr instanceof AAnnotationSearchExpr || expr instanceof ATextSearchExpr || expr instanceof AAnyNodeSearchExpr )
			return clone(expr);

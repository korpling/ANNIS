...
public class PathTranslator5 extends AbstractPathTranslator {
	...
	public void inAAbsolutePathType(AAbsolutePathType node) {
		path.addCondition(new IsNullCondition(target.getColumn("rank_struct", "parent")));
	}
...
//		path.addCondition(Join.eq(context.getColumn("annotations", "rank_struct"), target.getColumn("annotations", "rank_struct")));
	}

	@Override
	public void inAChildAxis(AChildAxis node) {
		path.addCondition(Join.eq(context.getColumn("rank_struct", "pre"), target.getColumn("rank_struct", "parent")));
	}
	...
	public void inAParentAxis(AParentAxis node) {
		...
		path.addCondition(Join.eq(context.getColumn("rank_struct", "pre"), helper.getColumn("rank_struct", "pre")));
		path.addCondition(Join.eq(helper.getColumn("rank_struct", "parent"), target.getColumn("rank_struct", "pre")));
	}
	
	// FIXME echt kleiner, größer
	@Override
	public void inADescendantAxis(ADescendantAxis node) {
		path.addCondition(Join.le(context.getColumn("rank_struct", "pre"), target.getColumn("rank_struct", "pre")));
		path.addCondition(Join.le(target.getColumn("rank_struct", "pre"), context.getColumn("rank_struct", "post")));
	}
	...
	public void inAAncestorAxis(AAncestorAxis node) {
		...
		// rank.pre = rank.pre (nicht struct.id = struct.id)
		path.addCondition(Join.eq(context.getColumn("rank_struct", "pre"), helper.getColumn("rank_struct", "pre")));
		path.addCondition(Join.ge(helper.getColumn("rank_struct", "pre"), target.getColumn("rank_struct", "pre")));
		path.addCondition(Join.ge(target.getColumn("rank_struct", "pre"), helper.getColumn("rank_struct", "post")));
	}
	
	@Override
	public void inASiblingAxis(ASiblingAxis node) {
		path.addCondition(Join.eq(context.getColumn("rank_struct", "parent"), target.getColumn("rank_struct", "parent")));
	}
	
	@Override
	public void inAFollowingAxis(AFollowingAxis node) {
		path.addCondition(Join.eq(context.getColumn("rank_struct", "text_ref"), target.getColumn("rank_struct", "text_ref")));
		path.addCondition(Join.lt(context.getColumn("rank_struct", "token_right"), target.getColumn("rank_struct", "token_left")));
	}
	
	@Override
	public void inAPrecedingAxis(APrecedingAxis node) {
		path.addCondition(Join.eq(context.getColumn("rank_struct", "text_ref"), target.getColumn("rank_struct", "text_ref")));
		path.addCondition(Join.gt(context.getColumn("rank_struct", "token_right"), target.getColumn("rank_struct", "token_left")));
	}
	...
	public void inAPrecedingSiblingAxis(APrecedingSiblingAxis node) {
		path.addCondition(Join.eq(context.getColumn("rank_struct", "parent"), target.getColumn("rank_struct", "parent")));
		path.addCondition(Join.eq(context.getColumn("rank_struct", "text_ref"), target.getColumn("rank_struct", "text_ref")));
		path.addCondition(Join.gt(context.getColumn("rank_struct", "token_left"), target.getColumn("rank_struct", "token_right")));
	}
	
	@Override
	public void inAContainedAxis(AContainedAxis node) {
		path.addCondition(Join.ge(context.getColumn("rank_struct", "right"), target.getColumn("rank_struct", "right")));
		path.addCondition(Join.le(context.getColumn("rank_struct", "left"), target.getColumn("rank_struct", "left")));
	}
	
	@Override
	public void inAContainingAxis(AContainingAxis node) {
		path.addCondition(Join.le(context.getColumn("rank_struct", "right"), target.getColumn("rank_struct", "right")));
		path.addCondition(Join.ge(context.getColumn("rank_struct", "left"), target.getColumn("rank_struct", "left")));
	}
	
	@Override
	public void inAPrefixAxis(APrefixAxis node) {
		path.addCondition(Join.eq(context.getColumn("rank_struct", "text_ref"), target.getColumn("rank_struct", "text_ref")));
		path.addCondition(Join.eq(context.getColumn("rank_struct", "right"), target.getColumn("rank_struct", "right")));
		path.addCondition(Join.le(context.getColumn("rank_struct", "left"), target.getColumn("rank_struct", "left")));
	}
	...
	public void inASuffixAxis(ASuffixAxis node) {
		path.addCondition(Join.eq(context.getColumn("rank_struct", "text_ref"), target.getColumn("rank_struct", "text_ref")));
		path.addCondition(Join.ge(context.getColumn("rank_struct", "right"), target.getColumn("rank_struct", "right")));
		path.addCondition(Join.eq(context.getColumn("rank_struct", "left"), target.getColumn("rank_struct", "left")));
	}
	...
	public void inAOverlappingAxis(AOverlappingAxis node) {
		...
		conjunction1.addCondition(Join.ge(context.getColumn("rank_struct", "left"), target.getColumn("rank_struct", "left")));
		conjunction1.addCondition(Join.le(context.getColumn("rank_struct", "left"), target.getColumn("rank_struct", "left")));
		Conjunction conjunction2 = new Conjunction();
		conjunction2.addCondition(Join.ge(context.getColumn("rank_struct", "right"), target.getColumn("rank_struct", "right")));
		conjunction2.addCondition(Join.le(context.getColumn("rank_struct", "right"), target.getColumn("rank_struct", "left")));
	...
	public void inAOverlappingPrecedingAxis(AOverlappingPrecedingAxis node) {
		path.addCondition(Join.eq(context.getColumn("rank_struct", "text_ref"), target.getColumn("rank_struct", "text_ref")));
		path.addCondition(Join.ge(context.getColumn("rank_struct", "right"), target.getColumn("rank_struct", "right")));
		path.addCondition(Join.le(context.getColumn("rank_struct", "right"), target.getColumn("rank_struct", "left")));
	}
	...
	public void inAImmediatelyFollowingAxis(AImmediatelyFollowingAxis node) {
		...
		path.addCondition(Join.eq(context.getColumn("rank_struct", "token_right"), target.getColumn("rank_struct", "token_left").toString() + " - 1"));
	}
...
//			path.addCondition(Join.eq(target.getColumn("annotations", "name"), "'" + token(node.getName()) + "'"));
	...
	public void inAAttributeNodeTest(AAttributeNodeTest node) {
		if (node.getName() != null) {
			path.addCondition(Join.eq(target.getColumn("annos", "attribute"), "'" + token(node.getName()) + "'"));
		}
		textValue = TextValue.Attribute;
		target.useTable("rank_struct");
	}
	...
	private JoinField textValue(APathExpr pathExpr) {
		...
		if (steps.isEmpty()) {
			if (oldTextValue == TextValue.Attribute)
				return new Column(target, "annos", "value");
			else
				return new Column(target, "rank_struct", "span");
		}
	...
	public void caseAOrExpr(AOrExpr node) {
		...
		condition.setLhs(target.getColumn("rank_struct", "pre"));

...
Ext.onReady(function()
{
  ...
  function getFields() {
    var fields = ['_id', '_textId', '_text', '_levels', '_namespaces', '_tokenLevels', '_markedObjects', '_matchStart', '_matchEnd'];
  ...
  {
    var action = 'new MetaDataWindow(' + value._id + ').show();';

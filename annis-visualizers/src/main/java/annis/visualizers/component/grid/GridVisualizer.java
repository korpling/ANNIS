 ...
 * Mappings: <br/>
 * <ul>
 * <li>It is possible to specify the order of annotation layers in each grid.
 ...
 * will be ordered alphabetically. You can also use regular expressions in the
 * <b>annos</b> mapping by enclosing it in slashes like in
 * <code>annos:/.*::v.+/,/(ns1::a|ns1::b|ns2::c)/</code>. Please note that the
 * regular expressions have to match the whole qualified name including the
 * namespace.</li>
 * <li><b>tok_anno:true</b> can be used to also display the annotations of the
 * token.</li>
 * <li><b>hide_tok:true</b> switches the line with the token value off.</li>
 * <li><b>show_ns</b> If set to "true" always show the namespace of the
 * annotations. Alternativly a comma-separated list of fully qualified
 * annotation names (e.g. {@code myns::lemma}) or regular expressions enclosed
 * in slashes (e.g. {@code /my.*::lem.+/} for which the namespace should be
 * shown can be given.</li>
 * <li><b>pdf_page_key</b>: name of the annotation that contains the pdf page
 * number</li>
 * </ul>
 *

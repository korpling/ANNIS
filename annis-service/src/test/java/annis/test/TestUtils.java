...
public class TestUtils {
     ...
     * 
     * @param keys
     *            The array that should be returned by the {@code getArray} method.
     */
     ...
     * 
     * @param clazz
     *            The type of class which should be contained in the set.
     ...
     * 
     * @param items
     *            Items that should be added to the set.
        ...
        return new TypeSafeMatcher<Collection<? extends Object>>() {
            ...
            public void describeTo(Description description) {
                description.appendText(
                        "a collection with " + size + " element" + (size == 1 ? "" : "s") + "; got: " + actual);
            }
    ...
    public static int uniqueInt(int minValue, int maxValue) {
        Validate.isTrue(maxValue > minValue,
                "maxValue (" + maxValue + ") is not larger than minValue (" + minValue + ")");
    ...
    /**
     * Generates a string consisting of {@code prefix} and a random suffix of 10
    ...
    /**
     * Generates a string consisting of {@code prefix} and a random suffix of
     * {@code length} characters or numbers.
     * 
     * @param prefix
     *            The prefix of the string.
     * @param length

...
public class TestDataObject {
    ...
    static class A extends DataObject {
         ...
         * 
         */
        private static final long serialVersionUID = 5144693798200328484L;
        private String s;
    ...
    static class B extends DataObject {
         ...
         * 
         */
        private static final long serialVersionUID = 4474266687590719022L;
        private String s;
    ...
    static class C extends DataObject {
         ...
         * 
         */
        private static final long serialVersionUID = 7531230489527266571L;
        private A a;

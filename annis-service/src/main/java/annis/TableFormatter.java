...
public class TableFormatter {
    ...
    public String formatAsTable(List<?> list, String... fields) {
        ...
        // turn vararg fields into list, because we may want to remove non-existing
        // fields later
        ...
        // it is possible that every column was removed earlier, because it was not a
        // field
        if (columns.isEmpty())
    ...
    private void printHeader(StringBuffer sb, List<String> columns, Map<String, Integer> columnSizes) {
        for (String column : columns) {
    ...
    private void printValues(StringBuffer sb, List<Map<String, String>> rows, List<String> columns,

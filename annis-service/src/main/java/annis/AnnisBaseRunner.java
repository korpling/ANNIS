...
public abstract class AnnisBaseRunner {
    ...
    private static void checkForAnnisHome() {
        ...
        if (annisHomePath == null) {
            throw new AnnisRunnerException("Please set the annis.home property to the ANNIS distribution directory.",
                    2);
        }
    ...
    protected void runCommand(String command, String args) {
        ...
        try {
            ...
            // FIXME: Exception-Handling is all over the place (refactor into a

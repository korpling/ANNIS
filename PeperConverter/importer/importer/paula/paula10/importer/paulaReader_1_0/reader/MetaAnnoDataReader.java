 ...
 * @version 1.0
 */
public class MetaAnnoDataReader extends PAULAReader 
{
//	 ============================================== private Variablen ==============================================
	private static final String TOOLNAME= 	"MetaAnnoDataReader";		//Name dieses Tools
	...
	private String paulaID= null;		//PAULA ID des Kontextdokumentes
	private String paulaType= null;		//Type des featList-Elementes
	private String xmlBase= null;		//Basis der Hrefs dieses KOntextdocumentes
	//	 *************************************** Meldungen ***************************************
...
//	 ============================================== Konstruktoren ==============================================
	 ...
	 */
	public MetaAnnoDataReader(	PAULAMapperInterface mapper,
									String korpusPath, 
									File paulaFile,
		...
		try
		{
			...
			else if (this.isTAGorAttribute(qName, TAG_FEAT_FEAT))
			{
				...
				{	
					...
					if (this.isTAGorAttribute(attributes.getQName(i), ATT_FEAT_FEAT_HREF))
				...
				//ruft den mapper auf, über das Interface PAULAMapperInterface 
				this.mapper.metaAnnoDataConnector(	this.korpusPath, this.paulaFile, 
													this.paulaID, this.paulaType, 
													this.xmlBase, featHref, featVal);
				/*

...
import importer.paula.paula10.util.settingMgr.SettingMgr;
import importer.paula.paula10.util.settingMgr.SettingObject;
...
//	 ============================================== private Variablen ==============================================
	...
	private static final String FILE_SETTING=		"/paula10/PAULAAnalyzer/PASettings.xml";					//Name der default Setting-Datei
	...
	private static final String FILE_LOG=			"/PAULAAnalyzer/settings/log4j.xml";			//Name der log4j Datei
...
//	 ============================================== Konstruktoren ==============================================
	 ...
	 */
	public PAULAAnalyzer() throws Exception
	{
		init(Logger.getLogger(PAULAAnalyzer.class), FILE_SETTING);
	}
...
//	 ============================================== private Methoden ==============================================
	...
	private Vector<AnalyzeContainer> analyzeFiles(Vector<AnalyzeContainer> aConList) throws Exception
	{
		...
		FileDepGraph depGraph= new FileDepGraph(this.logger);
...
//	 ============================================== �ffentliche Methoden ==============================================
	...
	public void readSettings() throws Exception
	{
		...
		for (AnalyzerParams aParam: this.anaParamlist)
		{
			//System.out.println("className:"+aParam.getClassName());
			File file= new File(aParam.getClassName());
			//System.out.println("file: "+ file.getAbsolutePath());
			aParam.setAnalyzer((AbstractAnalyzer) Class.forName(aParam.getClassName()).newInstance());
		}
		//MainAnalyzer initialisieren
		this.mainAnalyzer= new MainAnalyzer(this.anaParamlist, this.logger);
	}
	...
	public void loadAnalyzers(String setFile) throws Exception
	{
		...
		SettingMgr setMgr= new SettingMgr(this.getSettingDir() + setFile);
	...
	public void analyze(File folder, String ksFileName, boolean toDot) throws Exception
	{
		...
		xmlWriter.setSettingDir(this.getSettingDir());
	...
	public static void main(String args[])
	{
		...
		try
		{
			...
			else
			{
				...
				System.out.println(MSG_IN_PROCESS + envFolder.getCanonicalPath());

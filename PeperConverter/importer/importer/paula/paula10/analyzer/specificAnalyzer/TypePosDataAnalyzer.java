...
/**
 * Die Klasse TypePosDataAnalyzer kann Dateien vom Typ TypePosData klassifizieren.
 * @author Florian Zipser
 * @version 1.0
 */
public class TypePosDataAnalyzer extends AbstractAnalyzer 
{
//		 ============================================== private Variablen ==============================================
		private static final String TOOLNAME= 	"TypePosDataAnalyzer";	//Name dieses Tools
		private static final String VERSION= 	"1.0";					//Version dieses Tools
		private static final boolean DEBUG=	false;					//Debug-Schalter 
		
		private static final String KW_TYPE_POS=	"type_pos";		//Typ eines Documentes, dass dieser Analyzer KLassifizieren kann		
		
		private static final String anaType= "TypePosData";			//Name des Analyse Typs
		private static final String comment= "analyzed by: "+ TOOLNAME + " this document contains a type hierarchie over annotations.";			//Kommentar zu diesem Analyse Typ
...
//		 ============================================== öffentliche Methoden ==============================================
		 ...
		 */
		public TypePosDataAnalyzer() throws Exception
		{
...
//		 -------------------------- Start SAX-Methoden --------------------------
					            ...
					            Attributes attributes) throws SAXException
	{
		try
		{
			//Element STRUCTLIST gefunden
			if (this.canAnalyzeValue(qName, TAG_STRUCT_STRUCTLIST))
			{
				for (int i= 0; i < attributes.getLength(); i++)
				{
					//Attribut STRUCTLIST.TYPE gefunden
					if (this.canAnalyzeValue(attributes.getQName(i), ATT_STRUCT_STRUCTLIST_TYPE))
					{
						//TYPE= type_pos
						if (attributes.getValue(i).equalsIgnoreCase(KW_TYPE_POS))
						{

...
public interface PeperPackage extends EPackage {
	...
	/**
	 * The meta object id for the '<em>SCorpus</em>' data type.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.corpling.salt.model.salt.SCorpus
	 * @see de.corpling.peper.impl.PeperPackageImpl#getSCorpus()
	 * @generated
	 */
	int SCORPUS = 15;

	/**
	 * The meta object id for the '<em>SDocument</em>' data type.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.corpling.salt.model.salt.SDocument
	 * @see de.corpling.peper.impl.PeperPackageImpl#getSDocument()
	 * @generated
	 */
	int SDOCUMENT = 16;
	...
	/**
	 * Returns the meta object for data type '{@link de.corpling.salt.model.salt.SCorpus <em>SCorpus</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for data type '<em>SCorpus</em>'.
	 * @see de.corpling.salt.model.salt.SCorpus
	 * @model instanceClass="de.corpling.salt.model.salt.SCorpus"
	 * @generated
	 */
	EDataType getSCorpus();

	/**
	 * Returns the meta object for data type '{@link de.corpling.salt.model.salt.SDocument <em>SDocument</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for data type '<em>SDocument</em>'.
	 * @see de.corpling.salt.model.salt.SDocument
	 * @model instanceClass="de.corpling.salt.model.salt.SDocument"
	 * @generated
	 */
	EDataType getSDocument();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em>SCorpus</em>' data type.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.corpling.salt.model.salt.SCorpus
		 * @see de.corpling.peper.impl.PeperPackageImpl#getSCorpus()
		 * @generated
		 */
		EDataType SCORPUS = eINSTANCE.getSCorpus();

		/**
		 * The meta object literal for the '<em>SDocument</em>' data type.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.corpling.salt.model.salt.SDocument
		 * @see de.corpling.peper.impl.PeperPackageImpl#getSDocument()
		 * @generated
		 */
		EDataType SDOCUMENT = eINSTANCE.getSDocument();

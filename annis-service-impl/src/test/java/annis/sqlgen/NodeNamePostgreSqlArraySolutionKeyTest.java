...
public class NodeNamePostgreSqlArraySolutionKeyTest
{

  // class under test
  private SolutionKey<List<String>> key = new NodeNamePostgreSqlArraySolutionKey();
  ...
  public void shouldGenerateColumnsForInnerQuery()
  {
    ...
    // then
    List<String> expected = asList(nameAlias + " AS name" + index);

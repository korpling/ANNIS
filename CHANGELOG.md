...
- Upgraded to graphANNIS 2.0.0. Among other things, it resolves issues when importing large
  ...
  or other upgrade steps are required. The AQL interpretation and the web service API also remained
  the same.
...
[Unreleased]: https://github.com/korpling/ANNIS/compare/v4.6.2...HEAD

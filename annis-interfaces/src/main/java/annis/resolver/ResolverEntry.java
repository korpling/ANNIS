...
public class ResolverEntry implements Serializable {
   ...
   * 
   */
  private static final long serialVersionUID = 7039687021563781456L;
  ...
  public ResolverEntry(long id, String corpus, String version, String namespace,
      ElementType element, String visType, String displayName, String visibility,
      Properties mappings, int order) {
    this.id = id;
    this.corpus = corpus;
  ...
  public boolean equals(Object obj) {
    ...
    if (this.mappings != other.mappings
        && (this.mappings == null || !this.mappings.equals(other.mappings))) {
      return false;
    }

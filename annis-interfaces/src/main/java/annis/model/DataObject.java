 ...
 * 
 * <p>
 * Overrides equals() so that all fields in this class and its superclasses are checked for
 * equality. hashCode() is overridden accordingly.
 * 
 * <p>
...
public class DataObject implements Serializable {
  ...
  private static class FieldCallBackEqualsImpl implements FieldCallBack {
    ...
    public FieldCallBackEqualsImpl(Object _this, Object obj, EqualsBuilder equalsBuilder) {
      this._this = _this;
      this.obj = obj;
    ...
    public void doForField(Field field) throws IllegalAccessException {
      ...
      if (log.isDebugEnabled()) {
        ...
        try {
          ...
          log.error(
              "Exception while comparing " + fieldName + "(" + thisValue + ", " + otherValue + ")");
          throw e;
        }
      }
   ...
   * 
   */
  private static final long serialVersionUID = -2792413602177347501L;

...
public class QueryAnnotation implements Comparable<QueryAnnotation>, Serializable {
   ...
   * 
   */
  private static final long serialVersionUID = 3423171792520029059L;
  ...
  public QueryAnnotation(String namespace, String name, String value, TextMatching textMatching) {
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder().append(namespace).append(name).append(value).append(textMatching)
        .toHashCode();
  }

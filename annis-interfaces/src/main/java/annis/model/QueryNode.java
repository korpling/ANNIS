...
public class QueryNode implements Serializable {
  public static class Range implements Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = -5109652019460199498L;
    private int min;
    private int max;
  ...
  public enum TextMatching {
    ...
    EXACT_EQUAL("=", "\"", "=", false, false), REGEXP_EQUAL("~", "/", "=", true,
        false), EXACT_NOT_EQUAL("<>", "\"", "!=", false,
            true), REGEXP_NOT_EQUAL("!~", "/", "!=", true, true);
    ...
    private TextMatching(String sqlOperator, String annisQuote, String aqlOperator, boolean regex,
        boolean negated) {
   ...
   * 
   */
  private static final long serialVersionUID = 4515444143468546519L;
  ...
  public boolean equals(Object obj) {
    ...
    if (this.nodeAnnotations != other.nodeAnnotations
        && (this.nodeAnnotations == null || !this.nodeAnnotations.equals(other.nodeAnnotations))) {
      return false;
    }
  ...
  public String toAQLNodeFragment() {
    ...
    if (nodeAnnotations.isEmpty()) {
      ...
      QueryAnnotation anno =
          nodeAnnotations.toArray(new QueryAnnotation[nodeAnnotations.size()])[0];

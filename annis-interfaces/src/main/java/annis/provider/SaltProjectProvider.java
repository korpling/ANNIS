 ...
 */
@Provider
public class SaltProjectProvider
    implements MessageBodyWriter<SaltProject>, MessageBodyReader<SaltProject> {
  ...
  /**
   * An {@link InputStream} that delegates all of the actions to a delegate object but can't be
   * closed.
   *
   * In
   * {@link SaltProjectProvider#readFrom(java.lang.Class, java.lang.reflect.Type, java.lang.annotation.Annotation[], javax.ws.rs.core.MediaType, javax.ws.rs.core.MultivaluedMap, java.io.InputStream) }
   * we have to make sure the provided {@link InputStream} is not closed. Unfurtunally the SAX
   * parser will always close the stream and there seems to be no option to avoid that. Thus we use
   * this hack where the {@link #close() } function does nothing.
   */
  ...
  @Override
  public long getSize(SaltProject t, Class<?> type, Type genericType, Annotation[] annotations,
      MediaType mediaType) {
    return -1;
  }
  ...
  public boolean isReadable(Class<?> type, Type genericType, Annotation[] annotations,
    ...
    return (MediaType.APPLICATION_XML_TYPE.isCompatible(mediaType)
        ...
        || APPLICATION_XMI_XML.isCompatible(mediaType)) && SaltProject.class.isAssignableFrom(type);
  }
  ...
  @Override
  public SaltProject readFrom(Class<SaltProject> type, Type genericType, Annotation[] annotations,
  ...
  @Override
  public void writeTo(SaltProject project, Class<?> type, Type genericType,

...
public class GraphMLProvider implements MessageBodyWriter<SaltProject> {
  ...
  public static final MediaType APPLICATION_GRAPHML = new MediaType("application", "graphml+xml");
  ...
  @Override
  public void writeTo(SaltProject t, Class<?> type, Type genericType, Annotation[] annotations,

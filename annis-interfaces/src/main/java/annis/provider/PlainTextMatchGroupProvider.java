 ...
 */
@Provider
public class PlainTextMatchGroupProvider
    implements MessageBodyWriter<MatchGroup>, MessageBodyReader<MatchGroup> {

  @Override
  public long getSize(MatchGroup t, Class<?> type, Type genericType, Annotation[] annotations,
      MediaType mediaType) {
    return -1;
  }
  ...
  @Override
  public void writeTo(MatchGroup match, Class<?> type, Type genericType, Annotation[] annotations,

...
public class FrequencyTable implements Serializable {
  ...
  public static class Entry implements Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = 6889959359433806071L;
  ...
  public static class HighestCountComparator implements Comparator<Entry>, Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = 5945388648198262954L;
    ...
    public int compare(Entry lhs, Entry rhs) {
      ...
      int countCmp = Long.compare(lhs.getCount(), rhs.getCount());
      if (countCmp == 0) {
   ...
   * 
   */
  private static final long serialVersionUID = 3122712076468457349L;

 ...
 *
 * <p>
 * A {@link CorpusConfig} object wraps a {@link Properties} object. This Properties object stores
 * the corpus configuration as simple key-value pairs.
 * </p>
 *
 * @author thomas
...
public class CorpusConfig implements Serializable {
   ...
   * 
   */
  private static final long serialVersionUID = 4249490074791302962L;
   ...
   *
   * @return {@link Properties} in case, their was never set a configuration with
   *         {@link #setConfig(java.util.Properties)} or
   *         {@link #setConfig(java.lang.String, java.lang.String) }
   */

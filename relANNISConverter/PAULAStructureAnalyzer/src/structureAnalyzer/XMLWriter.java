...
import util.korpGraph.Graph;
import util.korpGraph.Node;
import util.korpGraph.TraversalObject;
...
//	 ============================================== private Variablen ==============================================
	...
	private static final String PATH_DTD= "./PAULAStructureAnalyzer/settings/";		//Pfad zur DTD
...
// --------------------- Ende Methoden vom TraversalObject ---------------------
	...
	public void printTree(File outFile, Graph korpTree, String KW_FILE) throws Exception
	{
		...
		File srcDTDFile= new File(PATH_DTD+ FILE_DTD);

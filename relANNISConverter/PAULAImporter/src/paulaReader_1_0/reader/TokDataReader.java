...
/**
 * Dieser Reader liest ein PAULA 1.0 Dokument aus, dass dem Typ tokData genügt. 
 * Es werden alle Tokenknoten gelesen und mitsamt ihrer Daten, über ein Callback, 
 ...
 *
 */
public class TokDataReader extends PAULAReader 
{
//	 ============================================== private Variablen ==============================================
	private static final String TOOLNAME= 		"TokDataReader";		//Name dieses Tools
	private static final String PAULA_CTYPE=	"TokData";			//Unterstützter PAULA-Standard
...
//	 ============================================== Konstruktoren ==============================================
	 ...
	 */
	public TokDataReader(	PAULAMapperInterface mapper,
							String korpusPath, 
							File paulaFile,
            					...
            					Attributes attributes) throws SAXException
    {
		...
		try
		{
			...
			else if (this.isTAGorAttribute(qName, TAG_MARK_MARK))
			{
				...
				this.mapper.tokDataConnector(this.korpusPath, this.paulaFile, this.paulaID, this.paulaType, this.xmlBase, markID, markHref, markType);
			}
		}
		catch (Exception e)
		{

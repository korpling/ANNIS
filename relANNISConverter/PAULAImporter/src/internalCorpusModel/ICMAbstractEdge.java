...
/**
 * Diese Klasse stellt einen abstrakten Kantentyp zur Verfügung. Objekte dieses Typs verbinden
 * IKMAbtractNode-Objekte miteinander.
 * @author Florian Zipser
 * @version 1.0
 *
 */
public class ICMAbstractEdge extends Edge 
{
	private static final String TOOLNAME= 	"IKMAbstractEdge";		//Name dieses Tools
...
//	 ============================================== Konstruktoren ==============================================
	 ...
	 */
	public ICMAbstractEdge(	ICMAbstractDN fromNode, 
	 ...
	 * @param toNode Node -  Zielknoten, zu dem die Kante geht
	 */
	public ICMAbstractEdge(		String name,

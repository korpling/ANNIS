...
/**
 * Diese Klasse stellt eine Dominanzkante in einem Korpusgraphen dar.
 * @author Florian Zipser
 * @version 1.0
 *
 */
public abstract class ICMDominanceEdge extends ICMAbstractEdge
{
//	 ============================================== private Variablen ==============================================
	private static final String TOOLNAME= 	"IKMDominanceEdge";		//Name dieses Tools
...
//	 ============================================== Konstruktoren ==============================================
	 ...
	 */
	public ICMDominanceEdge(	ICMAbstractDN fromNode, 
	 ...
	 * @param toNode Node -  Zielknoten, zu dem die Kante geht
	 */
	public ICMDominanceEdge(	String name,

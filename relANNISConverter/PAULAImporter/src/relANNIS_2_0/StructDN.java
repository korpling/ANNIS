...
public class StructDN extends ICMStructDN implements RelationalDN, TextedDN
{
//	 ============================================== private Variablen ==============================================
	private static final String TOOLNAME= 	"StructDN";		//Name dieses Tools
...
//	 ============================================== Konstruktoren ==============================================
	 ...
	 */
	public StructDN(	String uniqueName,
						String name,
						String ns, 
						String type,
						CollectionDN colDN,
						Vector<TextedDN> refNodes) throws Exception
	{
		...
		if (!StructDN.factoryInit) throw new Exception(ERR_FACTORY_NOT_INIT);
...
//	 ============================================== private Methoden ==============================================
	...
	{
		TupleWriter tWriter= StructDN.dbConnector.getTWriter(StructDN.absRelName);
		...
		//doc_id-Wert setzen
		tuple.add(((DocDN)StructDN.kGraphMgr.getDocDN(primDN)).getRelID().toString());
		//Namensraum setzen

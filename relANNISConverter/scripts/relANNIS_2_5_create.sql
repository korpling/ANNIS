...
DROP INDEX IDX_d2c_doc_ref CASCADE;
DROP INDEX IDX_d2c_corp_ref CASCADE;
DROP INDEX IDX_STRUCT_ORDER CASCADE;
DROP INDEX IDX_STRUCT_DOC_REF CASCADE;
DROP INDEX IDX_rank_struct_ref CASCADE;
DROP INDEX IDX_rank_anno_rank_ref CASCADE;
DROP INDEX idx_aa_name CASCADE;


DROP TABLE meta_attribute CASCADE;
DROP TABLE anno_attribute CASCADE;
DROP TABLE anno CASCADE;
DROP TABLE "rank_anno" CASCADE;
DROP TABLE "rank" CASCADE;
DROP TABLE doc_2_corp CASCADE;
DROP TABLE struct CASCADE;
DROP TABLE text CASCADE;
DROP TABLE document CASCADE;
DROP TABLE corpus CASCADE;
DROP TABLE col_rank CASCADE;
...
(
	...
	CONSTRAINT "KEY_corpus_corp_id" UNIQUE (corp_id),
...
CREATE INDEX IDX_d2c_doc_ref ON doc_2_corp(doc_ref);
CREATE INDEX IDX_d2c_corp_ref ON doc_2_corp(corp_ref);
-- ===================================== Relation: text =====================================
CREATE TABLE text
(
	id 				numeric(38) NOT NULL,
...
CREATE INDEX IDX_STRUCT_DOC_REF on struct("doc_ref");
-- ===================================== Relation: rank =====================================
CREATE TABLE rank
(
	pre					numeric(38)	NOT NULL,
	...
	parent				numeric(38),
	dominance			boolean,	-- muss auch NULL zulassen aufgrund von Alibi-Einträgen
...
CREATE INDEX IDX_rank_anno_rank_ref ON rank_anno(rank_ref);
-- ===================================== Relation: anno =====================================
CREATE TABLE anno
(
	id 				numeric(38)	NOT NULL,
...
create index idx_anno_pk on anno(id);
...
CREATE INDEX idx_aa_name ON anno_attribute(name);
-- ===================================== Relation: anno_attribute =====================================
...
--(
--	id			numeric(38)					NOT NULL,
--	object_ref 	OID							NOT NULL,
--	name		character varying(150)		NOT NULL,
--	mime		character varying(50)		NOT NULL,
--	CONSTRAINT "PK_ext_data" PRIMARY KEY (id)
--);
--COMMENT ON TABLE anno_attribute IS 'The relation ext_data stores external data like audio files in blobs and references them per OID.';

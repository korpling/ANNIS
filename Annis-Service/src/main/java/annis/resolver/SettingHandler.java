 ...
 * Diese Objekte werden in Form einer Tabelle an die Klasse SettingHandler �bergeben. 
 * </p>
 * Unterst�tzt:
 * <ol>
 * 	<li>startDocument</li>
...
//	 ============================================== private Variablen ==============================================
	...
	private static final String KW_SETEL=	"setting";		//Keyword f�r Setting Element
	private static final String KW_ID=		"id";			//Keyword f�r id
	private static final String KW_XML_ID=	"xml:id";		//Keyword f�r id
	private static final String KW_NS=		"xmlns:";		//Keyword f�r Namespace
	private static final String KW_DEL_NS=	":";			//Delimiter f�r Namespaces und Elemente
	
	private static final String NS_SETMGR=	"irgendwo";		//Namensraum des XML-Files des SetMgr
	
	private Hashtable<String,String>  shortNS	= null;						//Hashtable f�r verwendete Namespacek�rzel
...
//	 ============================================== private Methoden ==============================================
	 ...
	 * (ohne Namensraum Prefix) und den Namensraum zur�ck (in langer Form).
	...
	private String[] getElemInfo(String qName) throws SAXException
	{
		...
		String ns= "";		//Namensraumk�rzel
		String elemName= "";	//bereinigter Elementname
		String fullNS= null;	//voller Namensraum (kein K�rzel)
...
//	 ************************************ SAX-Methoden ************************************
    ...
    */
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException
    {
		...
		//pr�fen ob Element aus Namensraum SetMgr kommt
		if ((fullNS != null) && (fullNS.equalsIgnoreCase(NS_SETMGR)))
		{
			...
			if (elemName.equalsIgnoreCase(KW_SETEL))
			{
				...
				//wenn es einen Listener zur aktuellen id gibt, f�ge ihn der aktuellen Liste hinzu
    ...
    public void endElement(String namespaceURI, String localName, String qName) throws SAXException
    {
		...
		if ((fullNS != null) && (fullNS.equalsIgnoreCase(NS_SETMGR)))
		{
			if (elemName.equalsIgnoreCase(KW_SETEL))
			{
				//Listener aus aktueller Liste l�schen, wenn vorhanden

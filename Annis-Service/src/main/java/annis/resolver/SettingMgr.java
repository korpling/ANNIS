...
/**
 * <p>
 * Die Klasse SettingMgr liest eine XML-Datei aus, die dem Schema setMgr.xsd gen�gt. In dieser 
 * Datei k�nnen Einstellungen an SettingListener gebunden werden. Diese Einstellungen werden vom
 * SttingMgr ausgelesen und an die entsprechenden SettingListener �bergeben. Ein SettingListener 
 ...
 * es werden folgende SAX-Methoden unterst�tzt.
 * </p>
 * Unterst�tzt:
 * <ol>
 * 	<li>startDocument</li>
...
//	 ============================================== private Variablen ==============================================
	...
	private Vector<SettingObject> setObjects= null;				//h�lt alle SettingObjects in einer Liste
	...
	//	 *************************************** Fehlermeldungen ***************************************
	private static final String ERR_NO_FILENAME				= "ERROR ("+CLASSNAME+"):"+CLASSNAME+" k�nnte nicht initialisiert werden. Keine InputXML-Datei angegeben.";
...
//	 ============================================== Konstruktoren ==============================================
	...
	{ 
		...
		if (!checkFile(fileName)) throw new Exception(ERR_NO_FILE + fileName);
...
//	 ============================================== private Methoden ==============================================
	...
	/**
	 * Pr�ft ob eine Datei mit dem gegebenen Namen existsieren.
	 * @param fileName - String, Name der Datei deren Existenz gepr�ft wird
...
//	 ============================================== �ffentl. Methoden ==============================================
	...
	/**
	 * F�gt dem SettingMgr ein Listener Objekt des Typs DefaultHandler2 hinzu, die Methoden 
	 ...
	 * @param setName - String, Name des SettingElements f�r das sich der Listener anmeldet 
	 */
	...
	/**
	 * F�gt Settinglistener und Settingnamen in die Liste der zu �berwachenden Elemente ein.
	 * Daf�r wird die Methode getSetEntry() des SettingObject aufgerufen und alle in der 
	 * Tabelle befindlichen Dettinglistener werden mit den dazugeh�rigen Settingnamen in die 
	 * �berwachungsliste eingef�gt
	...
	{
		//nur ausf�hren, wenn �berhaupt SettingListener vorhanden sind

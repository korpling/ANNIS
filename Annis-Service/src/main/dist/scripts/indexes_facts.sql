...
CREATE INDEX idx_c__parent__node_:id ON facts_:id (toplevel_corpus, parent);
CREATE INDEX idx_c__parent__token_:id ON facts_:id (toplevel_corpus, parent) WHERE token_index IS NULL;
CREATE INDEX idx_c__parent__span_:id ON facts_:id (toplevel_corpus, span varchar_pattern_ops, parent);
CREATE INDEX idx_c__parent__node_anno_ex_:id ON facts_:id (toplevel_corpus, node_annotation_name, parent);
CREATE INDEX idx_c__parent__node_anno_:id ON facts_:id (toplevel_corpus, node_annotation_name, node_annotation_value varchar_pattern_ops, parent);
CREATE INDEX idx_c__parent__edge_anno_ex_:id ON facts_:id (toplevel_corpus, edge_annotation_name, parent);
CREATE INDEX idx_c__parent__edge_anno_:id ON facts_:id (toplevel_corpus, edge_annotation_name, edge_annotation_value varchar_pattern_ops, parent);
...
CREATE INDEX idx_c__dom__node_:id ON facts_:id (toplevel_corpus, pre) WHERE edge_type = 'd';
CREATE INDEX idx_c__dom__token_:id ON facts_:id (toplevel_corpus, pre) WHERE token_index IS NULL AND edge_type = 'd';
CREATE INDEX idx_c__dom__span_:id ON facts_:id (toplevel_corpus, span varchar_pattern_ops, pre) WHERE edge_type = 'd';
CREATE INDEX idx_c__dom__node_anno_ex_:id ON facts_:id (toplevel_corpus, node_annotation_name, pre) WHERE edge_type = 'd';
CREATE INDEX idx_c__dom__node_anno_:id ON facts_:id (toplevel_corpus, node_annotation_name, node_annotation_value varchar_pattern_ops, pre) WHERE edge_type = 'd';
CREATE INDEX idx_c__dom__edge_anno_ex_:id ON facts_:id (toplevel_corpus, edge_annotation_name, pre) WHERE edge_type = 'd';
CREATE INDEX idx_c__dom__edge_anno_:id ON facts_:id (toplevel_corpus, edge_annotation_name, edge_annotation_value varchar_pattern_ops, pre) WHERE edge_type = 'd';
...
CREATE INDEX idx_c__pr__node_:id ON facts_:id (toplevel_corpus, edge_name, pre) WHERE edge_type = 'p';
CREATE INDEX idx_c__pr__token_:id ON facts_:id (toplevel_corpus, edge_name, pre) WHERE token_index IS NULL AND edge_type = 'p';
CREATE INDEX idx_c__pr__span_:id ON facts_:id (toplevel_corpus, span varchar_pattern_ops, edge_name, pre) WHERE edge_type = 'p';
CREATE INDEX idx_c__pr__node_anno_ex_:id ON facts_:id (toplevel_corpus, node_annotation_name, edge_name, pre) WHERE edge_type = 'p';
CREATE INDEX idx_c__pr__node_anno_:id ON facts_:id (toplevel_corpus, node_annotation_name, node_annotation_value varchar_pattern_ops, edge_name, pre) WHERE edge_type = 'p';
CREATE INDEX idx_c__pr__edge_anno_ex_:id ON facts_:id (toplevel_corpus, edge_annotation_name, edge_name, pre) WHERE edge_type = 'p';
CREATE INDEX idx_c__pr__edge_anno_:id ON facts_:id (toplevel_corpus, edge_annotation_name, edge_annotation_value varchar_pattern_ops, edge_name, pre) WHERE edge_type = 'p';
...
CREATE INDEX idx_c__text__node_:id ON facts_:id (toplevel_corpus, text_ref);
CREATE INDEX idx_c__text__token_:id ON facts_:id (toplevel_corpus, text_ref) WHERE token_index IS NULL;
CREATE INDEX idx_c__text__span_:id ON facts_:id (toplevel_corpus, span varchar_pattern_ops, text_ref);
CREATE INDEX idx_c__text__node_anno_ex_:id ON facts_:id (toplevel_corpus, node_annotation_name, text_ref);
CREATE INDEX idx_c__text__node_anno_:id ON facts_:id (toplevel_corpus, node_annotation_name, node_annotation_value varchar_pattern_ops, text_ref);
CREATE INDEX idx_c__text__edge_anno_ex_:id ON facts_:id (toplevel_corpus, edge_annotation_name, text_ref);
CREATE INDEX idx_c__text__edge_anno_:id ON facts_:id (toplevel_corpus, edge_annotation_name, edge_annotation_value varchar_pattern_ops, text_ref);

 ...
 *
 */
public class TestToken_Case2 extends MainTestCase
{
	/**
	 ...
	 * <!-- end-user-doc -->
	 */
	public TestToken_Case2(String name) {
		super(name);
		this.outputDir= new File("./outputDir/relANNISExporter");
		this.referenceDir= new File("./data/relANNISExporter/Token_Case2");
	}
	...
	protected void createDocumentStructure()
	{
		...
		//tok9->tok10
		pRel= SaltFWFactory.eINSTANCE.createSPointingRelation();
		pRel.setSSourceElement((SToken)sDocGraph.getSElementById("tok9"));
		pRel.setSDestinationElement((SToken)sDocGraph.getSElementById("tok10"));
		sDocGraph.addSRelation(pRel);

 ...
 *
 */
public class TestToken_Case3 extends MainTestCase
{
	/**
	 ...
	 * <!-- end-user-doc -->
	 */
	public TestToken_Case3(String name) {
		super(name);
		this.outputDir= new File("./outputDir/relANNISExporter");
		this.referenceDir= new File("./data/relANNISExporter/Token_Case3");
	}
	...
	protected void createDocumentStructure()
	{
		...
		*/
		...
		pRel= SaltFWFactory.eINSTANCE.createSPointingRelation();
		pRel.setSType(type);
		pRel.setSSourceElement((SToken)sDocGraph.getSElementById("tok5"));
		pRel.setSDestinationElement((SToken)sDocGraph.getSElementById("tok4"));
		sDocGraph.addSRelation(pRel);
		pRel= SaltFWFactory.eINSTANCE.createSPointingRelation();
		pRel.setSType(type);
		pRel.setSSourceElement((SToken)sDocGraph.getSElementById("tok5"));
		pRel.setSDestinationElement((SToken)sDocGraph.getSElementById("tok8"));
		sDocGraph.addSRelation(pRel);
		pRel= SaltFWFactory.eINSTANCE.createSPointingRelation();
		pRel.setSType(type);
		pRel.setSSourceElement((SToken)sDocGraph.getSElementById("tok6"));
		pRel.setSDestinationElement((SToken)sDocGraph.getSElementById("tok5"));
		sDocGraph.addSRelation(pRel);
		pRel= SaltFWFactory.eINSTANCE.createSPointingRelation();
		pRel.setSType(type);
		pRel.setSSourceElement((SToken)sDocGraph.getSElementById("tok7"));
		pRel.setSDestinationElement((SToken)sDocGraph.getSElementById("tok6"));
		sDocGraph.addSRelation(pRel);
		pRel= SaltFWFactory.eINSTANCE.createSPointingRelation();
		pRel.setSType(type);
		pRel.setSSourceElement((SToken)sDocGraph.getSElementById("tok7"));
		...
		pRel= SaltFWFactory.eINSTANCE.createSPointingRelation();
		pRel.setSType(type);
		pRel.setSSourceElement((SToken)sDocGraph.getSElementById("tok8"));
		pRel.setSDestinationElement((SToken)sDocGraph.getSElementById("tok9"));
		sDocGraph.addSRelation(pRel);
	}
}

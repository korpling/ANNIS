...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>relANNIS</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class RelANNISExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(RelANNISPackage.eNS_URI, 
			 RelANNISPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.relannis"));
				RAExporter root = RelANNISFactory.eINSTANCE.createRAExporter();

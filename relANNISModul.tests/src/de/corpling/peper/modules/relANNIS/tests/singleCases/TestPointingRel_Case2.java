 ...
 *
 */
public class TestPointingRel_Case2 extends MainTestCase
{
	/**
	 ...
	 * <!-- end-user-doc -->
	 */
	public TestPointingRel_Case2(String name) {
		super(name);
		this.outputDir= new File("./outputDir/relANNISExporter");
		this.referenceDir= new File("./data/relANNISExporter/PointingRel_Case2");
	}

...
/**
 * This test tests storing in relANNIS format with salt. The graph contains two texts.
 * 
 * 
 * @author Florian Zipser
 *
 */
public class TestText_Case2 extends MainTestCase
{
	/**
	 ...
	 * <!-- end-user-doc -->
	 */
	public TestText_Case2(String name) {
		super(name);
		this.outputDir= new File("./outputDir/relANNISExporter/");
		this.referenceDir= new File("./data/relANNISExporter/Text_Case2/");
	}
	...
	protected void createDocumentStructure()
	{
		...
		String text= "Hello this is a sample text to test storing texts.";
		sTextualDataSource.setSText(text);
		sDocGraph.addSElement(sTextualDataSource);
		
		sTextualDataSource= SaltFWFactory.eINSTANCE.createSTextualDataSource();
		sTextualDataSource.setId("text2");

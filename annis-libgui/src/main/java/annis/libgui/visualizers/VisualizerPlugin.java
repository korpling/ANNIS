 ...
 * {@link VisualizerPlugin#createComponent(annis.gui.visualizers.VisualizerInput) } method. Normally
 * you need a inner or additional class which extends a vaadin implementation of the
 * {@link Component} interface. The {@link annis.gui.visualizers.component.KWICPanel} is an example
 * for that.
 *

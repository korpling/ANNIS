...
# **nodeDescriptions**
> List&lt;QueryAttributeDescription&gt; nodeDescriptions(query, queryLanguage)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<QueryAttributeDescription> result = apiInstance.nodeDescriptions(query, queryLanguage);
      System.out.println(result);
    } catch (ApiException e) {
...
[**List&lt;QueryAttributeDescription&gt;**](QueryAttributeDescription.md)
